...
//         ros::package::getPath("field_local_planners") + "/config/controllers/rmp/";
...
//         dynamic_reconfigure::Server<field_local_planners::RmpControllerConfig>>(node_handle);
...
//     field_local_planners::RmpControllerConfig& config, uint32_t level)
// {
//     // RMP parameters
...
//         "/field_local_planners/rmp/control_points", 10);
//     accelerations_pub_ = node_handle.advertise<visualization_msgs::MarkerArray>(
//         "/field_local_planners/rmp/accelerations", 10);
// }
