...
//   parameters_.config_folder_   = ros::package::getPath("field_local_planners") + "/config/controllers/falco/";
//   // falco params
...
//   dynamic_reconfigure_server_ = std::make_shared<dynamic_reconfigure::Server<field_local_planners::FalcoControllerConfig>>(node_handle);
...
// // void FalcoController::dynamicReconfigureCallback(field_local_planners::FalcoControllerConfig &config, uint32_t level)
// // {
// //   // Falco parameters
...
// // {
// //   free_paths_pub_         = node_handle.advertise<sensor_msgs::PointCloud2>("/field_local_planners/falco/free_paths", 10);
// //   collision_map_pub_      = node_handle.advertise<sensor_msgs::PointCloud2>("/field_local_planners/falco/collision_map", 10);
// // }
