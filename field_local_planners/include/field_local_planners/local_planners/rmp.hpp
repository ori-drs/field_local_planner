...
//   void dynamicReconfigureCallback(field_local_planners::RmpControllerConfig &config, uint32_t level);
...
//   // Dynamic reconfigure
//   std::shared_ptr<dynamic_reconfigure::Server<field_local_planners::RmpControllerConfig>> dynamic_reconfigure_server_;
//   dynamic_reconfigure::Server<field_local_planners::RmpControllerConfig>::CallbackType dynamic_reconfigure_callback_;
