...
class BaseLocalPlanner {
 ...
 protected:
  ...
  //   virtual OutputAction computeCommandTurnToDestination(Eigen::Vector3d& output_linear_velocity, Eigen::Vector3d&
  //   output_angular_velocity) = 0; virtual OutputAction computeCommandFinished(Eigen::Vector3d& output_linear_velocity, Eigen::Vector3d&
  //   output_angular_velocity) = 0; virtual void computeCommandPostProcess(LocalPlannerBase::OutputAction& action,
