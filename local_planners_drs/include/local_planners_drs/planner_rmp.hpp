...
//   void dynamicReconfigureCallback(local_planners_drs::RmpControllerConfig &config, uint32_t level);
...
//   // Dynamic reconfigure
//   std::shared_ptr<dynamic_reconfigure::Server<local_planners_drs::RmpControllerConfig>> dynamic_reconfigure_server_;
//   dynamic_reconfigure::Server<local_planners_drs::RmpControllerConfig>::CallbackType dynamic_reconfigure_callback_;
